// File: studybuddy/app/set/adminsetviewer.tsx
// Description: Admin set viewer - same as regular set viewer but without quiz functionality and with admin routing
    ...
    return (
      <View style={styles.container}>
        ...
        <View style={styles.errorContainer}>
          ...
          <TouchableOpacity style={styles.backButton} onPress={() => router.push('/admin/sets')}>
    ...
    <GestureHandlerRootView style={styles.container}>
      ...
      <View style={styles.header}>
        ...
        <View style={styles.adminNotice}>
          <Text style={styles.adminNoticeText}>👨‍💼 Admin</Text>
        </View>
      </View>
